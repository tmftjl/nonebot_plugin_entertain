...
from ...core.framework.perm import _is_superuser, _uid, _has_group_role, PermLevel
...
# 创建插件实例（带统一权限）
P = Plugin(name="ai_chat", display_name="AI 对话", enabled=True, level=PermLevel.LOW, scene="all")
